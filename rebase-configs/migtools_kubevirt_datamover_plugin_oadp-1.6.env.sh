# ===============================================================
# KubeVirt Datamover Plugin rebase configuration for OADP 1.6
...
SOURCE_UPSTREAM_REPO="https://github.com/migtools/kubevirt-datamover-plugin:oadp-1.6"
DESTINATION_DOWNSTREAM_REPO="migtools/kubevirt-datamover-plugin:oadp-1.6"
REBASE_REPO="oadp-rebasebot/kubevirt-datamover-plugin:rebase-bot-oadp-1.6"
