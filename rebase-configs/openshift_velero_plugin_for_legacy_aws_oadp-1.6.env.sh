# ===============================================================
# Legacy AWS plugin (AWS SDK v1) rebase configuration for OADP 1.6
...
SOURCE_UPSTREAM_REPO="https://github.com/openshift/velero-plugin-for-legacy-aws:oadp-1.6"
DESTINATION_DOWNSTREAM_REPO="openshift/velero-plugin-for-legacy-aws:oadp-1.6"
REBASE_REPO="oadp-rebasebot/velero-plugin-for-legacy-aws:rebase-bot-oadp-1.6"
