...
HOOK_SCRIPTS="--post-rebase-hook git:https://github.com/oadp-rebasebot/oadp-rebase/oadp-dev:rebasebot-hook-scripts/go-replace_kopia_oadp-1.5.sh git:https://github.com/oadp-rebasebot/oadp-rebase/oadp-dev:rebasebot-hook-scripts/go-mod-tidy-and-commit.sh git:https://github.com/oadp-rebasebot/oadp-rebase/oadp-dev:restic-submodule-and-commit_oadp-1.5.sh"
