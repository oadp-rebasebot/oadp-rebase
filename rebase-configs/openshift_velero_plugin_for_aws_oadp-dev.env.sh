...
SOURCE_UPSTREAM_REPO="https://github.com/vmware-tanzu/velero-plugin-for-aws:$UPSTREAM_PLUGIN_BRANCH"
DESTINATION_DOWNSTREAM_REPO="openshift/velero-plugin-for-aws:$DESTINATION_DOWNSTREAM_PLUGIN_BRANCH"
REBASE_REPO="oadp-rebasebot/velero-plugin-for-aws:rebase-bot-$DESTINATION_DOWNSTREAM_PLUGIN_BRANCH"
