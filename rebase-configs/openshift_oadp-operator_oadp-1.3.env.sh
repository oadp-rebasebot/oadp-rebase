...
SOURCE_UPSTREAM_REPO="https://github.com/openshift/oadp-operator:oadp-1.3"
DESTINATION_DOWNSTREAM_REPO="openshift/oadp-operator:oadp-1.3"
REBASE_REPO="oadp-rebasebot/oadp-operator:rebase-bot-oadp-1.3"
...
HOOK_SCRIPTS="--post-rebase-hook \
  ...
  ${HOOK_SCRIPTS_LOCATION}/oadp-operator-copy-crds-from-velero-and-commit_oadp-1.3.sh \
