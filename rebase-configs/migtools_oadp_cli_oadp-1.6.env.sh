# ===============================================================
# OADP CLI rebase configuration for OADP 1.6
# Downstream-only repository (no upstream to rebase from).
# SOURCE and DESTINATION are the same; hooks update go.mod
# to point velero, kopia, and oadp-non-admin dependencies at oadp-1.6.
# ===============================================================

SOURCE_UPSTREAM_REPO="https://github.com/migtools/oadp-cli:oadp-1.6"
DESTINATION_DOWNSTREAM_REPO="migtools/oadp-cli:oadp-1.6"
REBASE_REPO="oadp-rebasebot/oadp-cli:rebase-bot-oadp-1.6"
