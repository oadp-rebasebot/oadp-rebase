# ===============================================================
# Azure plugin rebase configuration for OADP 1.6
# Uses upstream velero-plugin-for-microsoft-azure v1.14.0
# which corresponds to the Azure plugin version for Velero 1.18
# (v1.14.0 go.mod references github.com/vmware-tanzu/velero v1.18.0)
# ===============================================================

UPSTREAM_PLUGIN_REPO="vmware-tanzu/velero-plugin-for-microsoft-azure"
