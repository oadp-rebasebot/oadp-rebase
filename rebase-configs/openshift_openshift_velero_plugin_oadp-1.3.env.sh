# ===============================================================
# OpenShift Velero Plugin configuration for OADP 1.3
# Downstream-only repository (no upstream to rebase from).
# SOURCE and DESTINATION are the same; hooks update go.mod.
# ===============================================================

SOURCE_UPSTREAM_REPO="https://github.com/openshift/openshift-velero-plugin:oadp-1.3"
DESTINATION_DOWNSTREAM_REPO="openshift/openshift-velero-plugin:oadp-1.3"
REBASE_REPO="oadp-rebasebot/openshift-velero-plugin:rebase-bot-oadp-1.3"
