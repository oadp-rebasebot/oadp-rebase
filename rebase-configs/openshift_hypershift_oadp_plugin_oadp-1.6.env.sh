# ===============================================================
# HyperShift OADP Plugin rebase configuration for OADP 1.6
# Downstream-only repository (no upstream to rebase from).
# SOURCE and DESTINATION are the same; hooks update go.mod
# to point velero dependencies at oadp-1.6.
# ===============================================================

SOURCE_UPSTREAM_REPO="https://github.com/openshift/hypershift-oadp-plugin:oadp-1.6"
DESTINATION_DOWNSTREAM_REPO="openshift/hypershift-oadp-plugin:oadp-1.6"
REBASE_REPO="oadp-rebasebot/hypershift-oadp-plugin:rebase-bot-oadp-1.6"
