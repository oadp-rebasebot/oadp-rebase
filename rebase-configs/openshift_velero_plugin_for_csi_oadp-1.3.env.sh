# ===============================================================
# CSI Plugin rebase configuration for OADP 1.3
# Upstream tag sourced from versions/oadp-1.3.env
# (CSI plugin was merged into Velero core after v1.12)
# ===============================================================
...
DESTINATION_DOWNSTREAM_REPO="openshift/velero-plugin-for-csi:$DESTINATION_DOWNSTREAM_BRANCH"
REBASE_REPO="oadp-rebasebot/velero-plugin-for-csi:rebase-bot-$DESTINATION_DOWNSTREAM_BRANCH"
