# ===============================================================
# OADP Non-Admin configuration for OADP 1.4
# Downstream-only repository (no upstream to rebase from).
# SOURCE and DESTINATION are the same; hooks update go.mod.
# ===============================================================

SOURCE_UPSTREAM_REPO="https://github.com/migtools/oadp-non-admin:oadp-1.4"
DESTINATION_DOWNSTREAM_REPO="migtools/oadp-non-admin:oadp-1.4"
REBASE_REPO="oadp-rebasebot/oadp-non-admin:rebase-bot-oadp-1.4"
