# ===============================================================
# Legacy AWS plugin configuration for OADP 1.5
# Downstream-only repository (no upstream to rebase from).
# SOURCE and DESTINATION are the same; hooks update go.mod.
# ===============================================================

SOURCE_UPSTREAM_REPO="https://github.com/openshift/velero-plugin-for-legacy-aws:oadp-1.5"
DESTINATION_DOWNSTREAM_REPO="openshift/velero-plugin-for-legacy-aws:oadp-1.5"
REBASE_REPO="oadp-rebasebot/velero-plugin-for-legacy-aws:rebase-bot-oadp-1.5"
