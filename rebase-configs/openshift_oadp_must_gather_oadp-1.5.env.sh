# ===============================================================
# OADP Must-Gather configuration for OADP 1.5
# Downstream-only repository (no upstream to rebase from).
# SOURCE and DESTINATION are the same; hooks update go.mod
# and sync submodules.
# ===============================================================

SOURCE_UPSTREAM_REPO="https://github.com/openshift/oadp-must-gather:oadp-1.5"
DESTINATION_DOWNSTREAM_REPO="openshift/oadp-must-gather:oadp-1.5"
REBASE_REPO="oadp-rebasebot/oadp-must-gather:rebase-bot-oadp-1.5"
...
HOOK_SCRIPTS="--post-rebase-hook \
  ...
  ${HOOK_SCRIPTS_LOCATION}/velero-submodule-and-commit_oadp-1.5.sh \
  ${HOOK_SCRIPTS_LOCATION}/restic-submodule-and-commit_oadp-1.5.sh \
  ${HOOK_SCRIPTS_LOCATION}/kopia-submodule-and-commit_oadp-1.5.sh \
