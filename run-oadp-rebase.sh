...
get_wave_repos() {
    ...
    if [ "$branch" = "oadp-dev" ]; then
        case "$wave" in
            ...
            4) echo "oadp-non-admin-oadp-dev openshift-velero-plugin-oadp-dev kubevirt-datamover-controller-oadp-dev" ;;
        ...
        case "$wave" in
            ...
            4) echo "oadp-non-admin-oadp-1.6 openshift-velero-plugin-oadp-1.6 kubevirt-datamover-controller-oadp-1.6" ;;
