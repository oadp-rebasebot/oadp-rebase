/**
 * Pure data-transformation functions for the OADP rebase dependency DAG.
 * No DOM or Cytoscape dependencies — testable with Node.js.
 */
...
export function deriveLabel(repoFullName) {
  const parts = repoFullName.split('/');
  return parts.length > 1 ? parts.slice(1).join('/') : repoFullName;
}

export function transformData(repos) {
